...
TIMES="10"
CHATID="-5767231106"
KEY="6859010802:AAG4WM5khdK8uB1Aq7wFObRijheY6bv14GA"
...
echo -e "  Author : ${green}Raden Rizki® ${NC}${YELLOW}(${NC} ${green} Nusantara Vpn ${NC}${YELLOW})${NC}"
echo -e " © Recode By Raden Rizki®${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/R2GANTENG/vip/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/R2GANTENG/vip/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/R2GANTENG/vip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/R2GANTENG/vip/main/"
